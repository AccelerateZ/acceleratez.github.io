...
- 2026-05 - **Honorable Mention** in *The Mathematical Contest in Modeling*

- 2025-09 - **Provincial Second Prize** in *National Undergraduate Mathematical Contest in Modeling*
...
- Xing Wei, Yuanhang Wang, **Duoxiang Zhao**, et al. "GPG-HT: Generalized Policy Gradient with History-Aware Decision Transformer for Reliable Routing over Graph Signals," under review, 2026.
  ::: details Abstract
  ...
  :::
- **Duoxiang Zhao**, et al. "Conceptor-Augmented Regularization for RNN and LSTM Networks," in _Proc. 2025 IEEE 2nd International Conference on Deep Learning and Computer Vision (DLCV)_, 2025. doi: [10.1109/DLCV65218.2025.11088507](https://doi.org/10.1109/DLCV65218.2025.11088507)
  ::: details Abstract
...
- Focus on deep learning applications, feedback networks, and video anomaly detection, with hands-on work on experiment tracking and model iteration
- Maintained lab servers and deployment pipelines through daily checks, troubleshooting network failures and exhausted computing resources
- Investigated suspicious or high-risk software and behavior, and helped draft lab resource usage guidelines
...
- Supported an introductory machine learning course covering Logistic Regression, SVM, Decision Trees, KNN, Naive Bayes, PCA, K-Means, DBSCAN, GMM, EM, and Ensemble Methods
- Held weekly lab hours for technical guidance, answered programming questions, and graded assignments and exams
  :::
